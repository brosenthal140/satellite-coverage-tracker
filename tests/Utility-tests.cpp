...
{
	CoordGeodetic pos1(30.4382, 84.2806, 0, false); // Coordinate position of TLH airport
	CoordGeodetic pos2(33.9422, 118.4036, 0, false); // Coordinate position of LAX airport
